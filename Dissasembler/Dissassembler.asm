...
;**********************************************************************************************
	...
	Error_Message_4 db "Could not open writing file", 13, 10, "$"
	Error_Message_5 db "Could not read from file  ", 13, 10, "$"
	Error_Message_6 db "Could not write to file ", 13, 10, "$"
...
;	Call Open_Output_File
	Call Read_From_Input_File					;Fills First Buffed
;	Call Write_From_Input_File_To_Output_File
	Call Main_Function
	Jmp Close_Input_And_Output_Files
;**********************************************************************************************
...
Read_From_Input_File:
	...
	Mov Cx, Buffer_Length						;Buffer_Length Equ 16
	Mov Dx, Offset Buffer						;Read To
	Int 21h
	Jc Jump_To_Error_5
	ret
;**********************************************************************************************
Jump_To_Error_5:
	Jmp Error_5
;**********************************************************************************************
Write_From_Input_File_To_Output_File:
	Mov cx, ax
	Mov Ah, 40h
